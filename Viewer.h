...
#include <string>
#include <cstdint>
#include <tutorial/sandBox/OurMesh.h>
...
//    std::vector<ViewerPlugin*> plugins;
            ...
            public:
                ...
                void collapse();
                void rotateCylinder(int index, Eigen::Vector3d rot, double angle);
                Eigen::Vector3d getTip(int index);
                Eigen::Vector3d getP();
                Eigen::Vector3d getNewRotationVector(int indexOfLink);

                Eigen::Matrix4f getParentsTrans(int indexOfLink);

                void toFirstTip();

                bool meshPicked;

                Eigen::Matrix3d getParentsRotationMatrixes(int indexOfLink);

                Eigen::Matrix3d getParentsTouts(int indexOfLink);
            };
